...
execute ~./doom.sh~ to start DOOM on Emacs. You will need a WAD file which
contains the game data. The file ~doom1.wad~ is freely available. Error messages
will appear in the ~*doom-log*~ buffer.
